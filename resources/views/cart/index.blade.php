                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" class="border-0">
                                    <div class="p-2">
                                        ...
                                        <div class="ml-3 d-inline-block align-middle">
                                            <h5 class="mb-0"> <a href="{{ route('products.show', ['slug' => $Product->model->slug]) }}" class="text-dark d-inline-block align-middle">{{ $Product->model->title }}</a></h5><span class="text-muted font-weight-normal font-italic d-block"></span>
                                        </div>
                                    </div>
                                </th>
                                ...
                                <td class="border-0 align-middle">
                                    <form action="{{ route('cart.destroy', $Product->rowId) }}" method="get">
                                        @csrf
                                        @method('DELETE')
...
<div class="row py-5 p-4 bg-white rounded shadow-sm">
    ...
    <div class="p-4">
        ...
        </ul><a href="{{route('checkout.index')}}" class="btn btn-dark rounded-pill py-2 btn-block">FINALISER VOTRE COMMANDE</a>
    </div>
    </div>
</div>
</div>
...
<div class="row py-5 p-4 bg-white rounded shadow-sm">
    <div class="col-lg-12">
        ...
        </ul><a href="{{route('products.index')}}" class="btn btn-dark rounded-pill py-2 btn-block mt-2">COMMENCER VOS ACHATS</a>
